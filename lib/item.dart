...
class Item extends StatefulWidget {
  final argumentmode;
  final id;
  Item(this.argumentmode,this.id);
...
class _ItemState extends State<Item> {
  ...
  void insert() async {
    if(memostyle==false){
      return await  DBProvider().insert(
          Itemkun(
                                  ...
                                  child:Column(
                                    children: <Widget>[
                                      Container(
                                          ...
                                          child: Text("DELETE THIS ITEM?", style: TextStyle(color: Colors.brown[800], fontSize: 20, fontWeight: FontWeight.w500))),
                                      Container(
                                        height:height*0.05,
                                        width: width*0.7,
                                        child: Row(
                                            ...
                                            children: <Widget>[
                                              InkWell(
                                                  child: Container(
                                                      ...
                                                      child: Text('Cancel', style: TextStyle(color: Colors.brown[800], fontSize: 18, fontWeight: FontWeight.w500))),
                                                  onTap: (){
                                              ...
                                              InkWell(child: Container(
                                                  ...
                                                  child: Text('Delete', style: TextStyle(color: Colors.brown[800], fontSize: 18, fontWeight: FontWeight.w500))),
                                                  onTap: (){
